      ...
      <div class="admin-body">
        ...
        <div class="table">
          <div class="table-title">
            <label :for="club.name+' Products'" v-if="club">{{club.name}} Products</label>
...
export default {
  ...
  methods: {
    ...
    getItems() {
      this.isLoading = true;
      this.newItem.club_id = this.$route.params.id;
      this.$store.dispatch("GET_CLUB_PRODUCTS", this.$route.params.id).then((response) => {
    ...
    addItems() {
      this.isLoading = true;
      this.$store
        .dispatch("ADD_CLUB_PRODUCTS", this.newItem)
        .then((response) => {
    ...
    updateItems() {
      this.isLoading = true;
      this.$store
        .dispatch("UPDATE_CLUB_PRODUCTS", this.selectedItem)
        .then((response) => {
          if (response.data.status == "ok") {
            this.$notify({
              group: "status",
    ...
    deleteItems() {
      this.isLoading = true;
      this.$store
        .dispatch("DELETE_CLUB_PRODUCTS", this.selectedItem.id)
        .then((response) => {
          if (response.data.status == "ok") {
            this.$notify({
              group: "status",
