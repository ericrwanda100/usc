      ...
      <div class="admin-body">
        ...
        <div class="table">
          <div class="table-title">
            <label :for="hotel.name + ' Products'" v-if="hotel"
              >{{ hotel.name }} Products</label
            >
...
export default {
  ...
  methods: {
    ...
    getItems() {
      ...
      this.$store
        .dispatch("GET_HOTEL_PRODUCTS", this.$route.params.id)
        .then((response) => {
    ...
    addItems() {
      ...
      this.$store
        .dispatch("ADD_HOTEL_PRODUCTS", this.newItem)
        .then((response) => {
    ...
    updateItems() {
      this.isLoading = true;
      this.$store
        .dispatch("UPDATE_HOTEL_PRODUCTS", this.selectedItem)
        .then((response) => {
          if (response.data.status == "ok") {
            this.$notify({
              group: "status",
    ...
    deleteItems() {
      this.isLoading = true;
      this.$store
        .dispatch("DELETE_HOTEL_PRODUCTS", this.selectedItem.id)
        .then((response) => {
          if (response.data.status == "ok") {
            this.$notify({
              group: "status",
